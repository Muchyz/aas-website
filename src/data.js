...
export const SERVICES = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Power, control & communication cables", image: "/services/products/cables.jpg", description: "Cabling for power distribution, control signals, and data communication." },
      { name: "Networking equipment", image: "/services/products/networking.jpg", description: "Switches, routers, and industrial networking gear for connected systems." },
    ],
  },
  {
...
export const BRANDS = [
  ...
  { name: "Phoenix Contact", logo: "/brands/phoenix-contact.jpg" },
  { name: "Greystone", logo: "/brands/greystone.jpg" },
];
